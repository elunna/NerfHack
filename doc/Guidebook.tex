...
%.lp ""
On UNIX, Linux and macOS it is \mbox{``.hackemrc''} in the user's home
directory.
The file may not exist, but it is a normal ASCII text file and
can be created with any text editor.\\

%.lp ""
On Windows, the name is \mbox{``.hackemrc''} location in the folder
...
defaults to the location of the {\it hackem.exe\/} or {\it hackemW.exe\/} file
...
individually within your own hackem.rc file.
