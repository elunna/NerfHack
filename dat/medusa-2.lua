-- NetHack medusa medusa-2.lua	$NHDT-Date: 1781994882 2026/06/20 22:34:42 $  $NHDT-Branch: NetHack-5.0 $:$NHDT-Revision: 1.5 $
...
des.monster({ id = "cobra",x=64,y=10 })
des.monster({ id = "cobra",x=65,y=10 })
des.monster("A",72,08)
des.monster({ id = "yellow light",x=72,y=11 })
