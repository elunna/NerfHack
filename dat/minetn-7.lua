-- NetHack mines minetn-7.lua	$NHDT-Date: 1781994885 2026/06/20 22:34:45 $  $NHDT-Branch: NetHack-5.0 $:$NHDT-Revision: 1.4 $
...
des.room({ type="ordinary", lit=1, x=3,y=3,
           ...
           contents = function()
              ...
              des.room({ type="shop", chance=90, lit=1, x=14,y=10, w=2,h=3,
                         contents = function()
                            des.door({ state = "closed", wall="north" })
                         end
              })
              ...
              des.room({ type="tool shop", chance=45, lit=1, x=25,y=2, w=3,h=3,
                         contents = function()
