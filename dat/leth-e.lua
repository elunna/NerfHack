...
-- Trolls
des.monster({ id = "troll", x=24,y=02  })
des.monster({ id = "troll", x=26,y=02  })
des.monster({ id = "troll", x=24,y=05  })
des.monster({ id = "troll", x=26,y=05  })
des.monster({ id = "troll", x=32,y=02  })
des.monster({ id = "troll", x=34,y=02  })
des.monster({ id = "troll", x=32,y=05  })
des.monster({ id = "troll", x=34,y=05  })
des.monster("T")
des.monster("T")
des.monster("T")
des.monster("T")
