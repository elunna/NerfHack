...
-- Northern drawbridges
des.drawbridge({ x=24, y=02, dir="south", state="closed" })
des.drawbridge({ x=25, y=02, dir="south", state="closed" })
...
-- Some tempting damsels/dudes for our hero
