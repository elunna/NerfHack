...
const struct ForgeRecipe fusions[] = {
    ...
    { HALBERD,              DWARVISH_MATTOCK,   PEAR,           1, 1 },
    { BARDICHE,             BATTLE_AXE,         SPEAR,          1, 1 },
    { BARDICHE,             DWARVISH_MATTOCK, DWARVISH_MATTOCK, 1, 1 },
    ...
    { LUCERN_HAMMER,        WAR_HAMMER,       DWARVISH_MATTOCK, 1, 1 },
