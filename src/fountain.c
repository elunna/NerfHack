 ...
 * General rules governing forging:
 * 1) Any item can be reforged when you have the multiples of the same item
 *    type. This lets the player combine different materials, properties,
 *    enchantment, etc.
 * 2) Missiles like arrows, darts, crossbow bolts, and shuriken cannot be
 *    created from forging.
 * 3) Racial items tend to dead end in their respective group.
 *    ie: Elven spears can't be used as spears in other recipes.
 * 4) No item has more than one recipe (except its own self-forging path)
...
const struct ForgeRecipe fusions[] = {
    ...
    { ELVEN_LONG_SWORD,     ELVEN_SHORT_SWORD,  BROADSWORD,     1, 1 },
    ...
    { KATANA,               LONG_SWORD,         BROADSWORD,     1, 1 },
    { KNIFE,                ARROW,              DART,           2, 2 },
    { LONG_SWORD,           SHORT_SWORD,        BROADSWORD,     1, 1 },
    ...
    { ORCISH_LONG_SWORD,    ORCISH_SHORT_SWORD, BROADSWORD,     1, 1 },
    ...
    { TWO_HANDED_SWORD,     BATTLE_AXE,         BROADSWORD,     1, 1 },
    { WAR_HAMMER,           MACE,               FLAIL,          1, 1 },

    /* polearms recipes */
    { BARDICHE,             BATTLE_AXE,         JAVELIN,          1, 1 },
    { BEC_DE_CORBIN,        WAR_HAMMER,         SPEAR,          1, 1 },
    { BILL_GUISARME,        GUISARME,           JAVELIN,          1, 1 },
    { FAUCHARD,             SABER,              JAVELIN,          1, 1 },
    { GLAIVE,               SHORT_SWORD,        JAVELIN,          1, 1 },
    { GUISARME,             GRAPPLING_HOOK,     JAVELIN,          1, 1 },
    { HALBERD,              RANSEUR,            AXE,            1, 1 },
    { LANCE,                GLAIVE,             JAVELIN,        1, 1 },
    { LUCERN_HAMMER,        WAR_HAMMER,         JAVELIN,        1, 1 },
    { PARTISAN,             BROADSWORD,         JAVELIN,          1, 1 },
    { RANSEUR,              STILETTO,           JAVELIN,          1, 1 },
    { SPETUM,               KNIFE,              JAVELIN,          1, 1 },
    { VOULGE,               AXE,                JAVELIN,          1, 1 },
    ...
    { ORCISH_LONG_SWORD,    ORCISH_LONG_SWORD,  ORCISH_LONG_SWORD, 1, 1 },
    { ORCISH_RING_MAIL,     ORCISH_RING_MAIL,   ORCISH_RING_MAIL, 1, 1 },
    { ORCISH_SCIMITAR,      ORCISH_SCIMITAR,    ORCISH_SCIMITAR, 1, 1 },
    ...
    { PICK_AXE,             PICK_AXE,           PICK_AXE,       1, 1 },
