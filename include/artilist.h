...
static NEARDATA struct artifact artilist[] = {
    ...
    A("Mayhem", STOMPING_BOOTS,
      ...
      5000L, NO_COLOR, MAYHEM),
    
    A("The End", SCYTHE, 
      (SPFX_RESTR | SPFX_DEFN), 0, 0, COLD(3, 20), DFNS(AD_DRLI), NO_CARY, 0, 
    ...
    A("Mjollnir", WAR_HAMMER, /* Mjo:llnir */
      ...
      LIGHTNING_BOLT, A_NEUTRAL, PM_VALKYRIE, NON_PM, 4000L, NO_COLOR, MJOLLNIR),
    ...
    *       Seafoam grants waterbreathing, and is generated rustproof.
    ...
    A("Load Brand", HEAVY_SWORD, (SPFX_RESTR | SPFX_PROTECT | SPFX_HPHDAM),
      0, 0, PHYS(5, 20), NO_DFNS, NO_CARY, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, LOAD_BRAND),
    ...
    A("Blackshroud", CLOAK_OF_INVISIBILITY, (SPFX_RESTR | SPFX_WARN), 0, 0,
