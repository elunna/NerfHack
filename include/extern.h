...
extern void artifact_sanity_check(void);
...
extern const char *random_oprop_wishname(void);
...
extern boolean is_tree(coordxy, coordxy);
...
extern int disintegrate_arm(struct obj *, boolean, boolean);
...
extern void pets_seize_weakness(struct monst *);
...
extern boolean may_passtree(coordxy, coordxy);
...
extern struct monst * summon_minion(aligntyp, boolean);
...
extern void mhitm_ad_acid(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *) NONNULLPTRS;
extern void mhitm_ad_vuln(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *) NONNULLPTRS;
...
extern void mhitm_ad_phys(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *) NONNULLPTRS;
extern void mhitm_ad_chok(struct monst *, struct attack *, struct monst *,
                          struct mhitm_data *) NONNULLPTRS;
...
extern void fuzzer_save_restore(void);
extern void fuzzer_set_die_pct(int);
extern void fuzzer_arm_escape(void);
extern boolean fuzzer_escaping(void);
extern boolean fuzzer_lets_end(int);
extern void fuzzer_escape_step(void);
extern void fuzzer_arm_ascend(void);
