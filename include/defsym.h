...
#define PCHAR2(idx, ch, sym, tilenm, desc, clr) PCHAR(idx, ch, sym, desc, clr)
    ...
    PCHAR( 37, '#',  S_toilet, "toilet", CLR_YELLOW)
    PCHAR( 38, '{',  S_forge, "forge", CLR_ORANGE)
    PCHAR( 39, '{',  S_fountain, "fountain", CLR_BRIGHT_BLUE)
    /* the S_pool symbol is used for both POOL terrain and MOAT terrain */
    PCHAR2(40, '}',  S_pool,   "pool", "water", CLR_BLUE)
    PCHAR( 41, '.',  S_ice,    "ice", CLR_CYAN)
    PCHAR( 42, ',',  S_grass,  "grass", CLR_GREEN)
    PCHAR( 43, '}',  S_lava,   "molten lava", CLR_RED)
    PCHAR( 44, '}',  S_lavawall,  "wall of lava", CLR_ORANGE)
    ...
    PCHAR2(48, '#',  S_hcdbridge, "horizontal closed drawbridge",
                                  "raised drawbridge", CLR_BROWN)
    PCHAR( 49, ' ',  S_air,    "air", CLR_CYAN)
    PCHAR( 50, '#',  S_cloud,  "cloud", CLR_GRAY)
    PCHAR( 51, '}',  S_puddle,    "puddle", CLR_CYAN)
    /* the S_water symbol is used for WATER terrain: wall of water in the
       dungeon and Plane of Water in the endgame */
    PCHAR( 52, '}',  S_water,  "water", CLR_BRIGHT_BLUE)
    /* end dungeon characters                                          */
    /*                                                                 */
    /* begin traps                                                     */
    /*                                                                 */
    PCHAR( 53, '^',  S_arrow_trap, "arrow trap", HI_METAL)
    PCHAR( 54, '^',  S_dart_trap, "dart trap", HI_METAL)
    PCHAR( 55, '^',  S_falling_rock_trap, "falling rock trap", CLR_GRAY)
    PCHAR( 56, '^',  S_squeaky_board, "squeaky board", CLR_BROWN)
    PCHAR( 57, '^',  S_bear_trap, "bear trap", HI_METAL)
    PCHAR( 58, '^',  S_land_mine, "land mine", CLR_RED)
    PCHAR( 59, '^',  S_rolling_boulder_trap, "rolling boulder trap", CLR_GRAY)
    PCHAR( 60, '^',  S_sleeping_gas_trap, "sleeping gas trap", HI_ZAP)
    PCHAR( 61, '^',  S_rust_trap, "rust trap", CLR_BLUE)
    PCHAR( 62, '^',  S_grease_trap, "grease trap", CLR_GREEN)
    PCHAR( 63, '^',  S_fire_trap, "fire trap", CLR_ORANGE)
    PCHAR( 64, '^',  S_cold_trap, "cold trap", CLR_WHITE)
    PCHAR( 65, '^',  S_pit, "pit", CLR_BLACK)
    PCHAR( 66, '^',  S_spiked_pit, "spiked pit", CLR_BLACK)
    PCHAR( 67, '^',  S_hole, "hole", CLR_BROWN)
    PCHAR( 68, '^',  S_trap_door, "trap door", CLR_BROWN)
    PCHAR( 69, '^',  S_teleportation_trap, "teleportation trap", CLR_MAGENTA)
    PCHAR( 70, '^',  S_level_teleporter, "level teleporter", CLR_MAGENTA)
    PCHAR( 71, '^',  S_magic_portal, "magic portal", CLR_BRIGHT_MAGENTA)
    PCHAR( 72, '"',  S_web, "web", CLR_GRAY)
    PCHAR( 73, '^',  S_statue_trap, "statue trap", CLR_GRAY)
    PCHAR( 74, '^',  S_magic_trap, "magic trap", HI_ZAP)
    PCHAR2(75, '^',  S_anti_magic_trap, "anti magic trap", "anti-magic field",
                                        HI_ZAP)
    PCHAR( 76, '^',  S_polymorph_trap, "polymorph trap", CLR_BRIGHT_GREEN)
    PCHAR( 77, '^',  S_magic_beam_trap, "magic beam trap", CLR_YELLOW)
    PCHAR( 78, '^',  S_spear_trap, "spear trap", CLR_BROWN)
    ...
    /*                                                                   */
    PCHAR2(82, '|',  S_vbeam, "vertical beam", "", CLR_GRAY)
    PCHAR2(83, '-',  S_hbeam, "horizontal beam", "", CLR_GRAY)
    PCHAR2(84, '\\', S_lslant, "left slant beam", "", CLR_GRAY)
    PCHAR2(85, '/',  S_rslant, "right slant beam", "", CLR_GRAY)
    /* start cmap C */
    PCHAR2(86, '*',  S_digbeam, "dig beam", "", CLR_WHITE)
    PCHAR2(87, '!',  S_flashbeam, "flash beam", "", CLR_WHITE)
    PCHAR2(88, ')',  S_boomleft, "boom left", "", HI_WOOD)
    PCHAR2(89, '(',  S_boomright, "boom right", "", HI_WOOD)
    /* 4 magic shield symbols                                          */
    PCHAR2(90, '0',  S_ss1, "shield1", "", HI_ZAP)
    PCHAR2(91, '#',  S_ss2, "shield2", "", HI_ZAP)
    PCHAR2(92, '@',  S_ss3, "shield3", "", HI_ZAP)
    PCHAR2(93, '*',  S_ss4, "shield4", "", HI_ZAP)
    PCHAR( 94, '#',  S_poisoncloud, "poison cloud", CLR_BRIGHT_GREEN)
    ...
    PCHAR( 95, '$',  S_goodpos, "valid position", HI_ZAP)
    /* end cmap C */
    /*                                                             */
    ...
    /*      7 8 9                                                  */
    /*                                                             */
    PCHAR2(96, '/',  S_sw_tl, "swallow top left", "", CLR_GREEN)      /*1*/
    PCHAR2(97, '-',  S_sw_tc, "swallow top center", "", CLR_GREEN)    /*2*/
    PCHAR2(98, '\\', S_sw_tr, "swallow top right", "", CLR_GREEN)     /*3*/
    PCHAR2(99, '|',  S_sw_ml, "swallow middle left", "", CLR_GREEN)   /*4*/
    PCHAR2(100, '|',  S_sw_mr, "swallow middle right", "", CLR_GREEN)  /*6*/
    PCHAR2(101, '\\', S_sw_bl, "swallow bottom left", "", CLR_GREEN)   /*7*/
    PCHAR2(102, '-',  S_sw_bc, "swallow bottom center", "", CLR_GREEN) /*8*/
    PCHAR2(103, '/',  S_sw_br, "swallow bottom right", "", CLR_GREEN)  /*9*/
    /*                                                             */
    ...
    /*      \-/                                                    */
    /*                                                             */
    PCHAR2(104, '/',  S_expl_tl, "explosion top left", "", CLR_ORANGE)
    PCHAR2(105, '-',  S_expl_tc, "explosion top center", "", CLR_ORANGE)
    PCHAR2(106, '\\', S_expl_tr, "explosion top right", "", CLR_ORANGE)
    PCHAR2(107, '|',  S_expl_ml, "explosion middle left", "", CLR_ORANGE)
    PCHAR2(108, ' ',  S_expl_mc, "explosion middle center", "", CLR_ORANGE)
    PCHAR2(109, '|',  S_expl_mr, "explosion middle right", "", CLR_ORANGE)
    PCHAR2(110, '\\', S_expl_bl, "explosion bottom left", "", CLR_ORANGE)
    PCHAR2(111, '-', S_expl_bc, "explosion bottom center", "", CLR_ORANGE)
    PCHAR2(112, '/', S_expl_br, "explosion bottom right", "", CLR_ORANGE)
#undef PCHAR
#undef PCHAR2
...
#define MONSYM(idx, ch, basename, sym, desc) \
    ...
    MONSYM(60, '6', GRUNG, S_GRUNG, "grung")
    MONSYM(61, '7', MIGO, S_MIGO, "migo")
    MONSYM(62, '~', WORM_TAIL, S_WORM_TAIL, "long worm tail")
    MONSYM(63, ']', MIMIC_DEF, S_MIMIC_DEF, "mimic")
