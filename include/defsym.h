...
#define PCHAR2(idx, ch, sym, tilenm, desc, clr) PCHAR(idx, ch, sym, desc, clr)
    ...
    PCHAR( 51, '}',  S_water,  "water", CLR_BRIGHT_BLUE)
    /* end dungeon characters                                          */
    /*                                                                 */
    /* begin traps                                                     */
    /*                                                                 */
    PCHAR( 52, '^',  S_arrow_trap, "arrow trap", HI_METAL)
    PCHAR( 53, '^',  S_dart_trap, "dart trap", HI_METAL)
    PCHAR( 54, '^',  S_falling_rock_trap, "falling rock trap", CLR_GRAY)
    PCHAR( 55, '^',  S_squeaky_board, "squeaky board", CLR_BROWN)
    PCHAR( 56, '^',  S_bear_trap, "bear trap", HI_METAL)
    PCHAR( 57, '^',  S_land_mine, "land mine", CLR_RED)
    PCHAR( 58, '^',  S_rolling_boulder_trap, "rolling boulder trap", CLR_GRAY)
    PCHAR( 59, '^',  S_sleeping_gas_trap, "sleeping gas trap", HI_ZAP)
    PCHAR( 60, '^',  S_rust_trap, "rust trap", CLR_BLUE)
    PCHAR( 61, '^',  S_grease_trap, "grease trap", CLR_GREEN)
    PCHAR( 62, '^',  S_fire_trap, "fire trap", CLR_ORANGE)
    PCHAR( 63, '^',  S_cold_trap, "cold trap", CLR_WHITE)
    PCHAR( 64, '^',  S_pit, "pit", CLR_BLACK)
    PCHAR( 65, '^',  S_spiked_pit, "spiked pit", CLR_BLACK)
    PCHAR( 66, '^',  S_hole, "hole", CLR_BROWN)
    PCHAR( 67, '^',  S_trap_door, "trap door", CLR_BROWN)
    PCHAR( 68, '^',  S_teleportation_trap, "teleportation trap", CLR_MAGENTA)
    PCHAR( 69, '^',  S_level_teleporter, "level teleporter", CLR_MAGENTA)
    PCHAR( 70, '^',  S_magic_portal, "magic portal", CLR_BRIGHT_MAGENTA)
    PCHAR( 71, '"',  S_web, "web", CLR_GRAY)
    PCHAR( 72, '^',  S_statue_trap, "statue trap", CLR_GRAY)
    PCHAR( 73, '^',  S_magic_trap, "magic trap", HI_ZAP)
    PCHAR2(74, '^',  S_anti_magic_trap, "anti magic trap", "anti-magic field",
                                        HI_ZAP)
    PCHAR( 75, '^',  S_polymorph_trap, "polymorph trap", CLR_BRIGHT_GREEN)
    PCHAR( 76, '^',  S_magic_beam_trap, "magic beam trap", CLR_YELLOW)
    PCHAR( 77, '^',  S_spear_trap, "spear trap", CLR_BROWN)
