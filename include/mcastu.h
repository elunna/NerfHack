...
MONSPELL(BLOOD_RAIN,   "blood rain",       1, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
...
MONSPELL(DISGUISE,     "disguise self",    5, MCF_HOSTILE | MCF_INDIRECT | MCF_VS_HERO),
...
MONSPELL(LEVITATE,     "levitation",      10, MCF_HOSTILE | MCF_SIGHT),
