...
MONSPELL(SPHERES,      "spheres",          0, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
MONSPELL(CURE_SELF,    "cure self",        1, MCF_INDIRECT),
MONSPELL(DARKNESS,     "darkness",         1, MCF_HOSTILE | MCF_SIGHT | MCF_VS_HERO),
MONSPELL(GREASE,       "grease",           1, MCF_HOSTILE | MCF_SIGHT),
MONSPELL(BLOOD_RAIN,   "blood rain",       1, MCF_HOSTILE | MCF_INDIRECT | MCF_VS_HERO),
...
MONSPELL(VULN,         "vulnerability",    4, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT),
MONSPELL(LEVITATE,     "levitation",       4, MCF_HOSTILE | MCF_SIGHT),
MONSPELL(DISGUISE,     "disguise self",    4, MCF_HOSTILE | MCF_INDIRECT | MCF_VS_HERO),
MONSPELL(BLIGHT,       "blight",           6, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT),
...
MONSPELL(MIRROR_IMAGE, "mirror image",     8, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
MONSPELL(BLOOD_SPEAR,  "bloody pierce",    8, MCF_HOSTILE | MCF_SIGHT | MCF_INDIRECT),
MONSPELL(INSECTS,      "summon vermin",    8, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
...
MONSPELL(CALL_UNDEAD,  "call undead",     10, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
MONSPELL(LIGHTNING,    "lightning bolt",  11, MCF_HOSTILE | MCF_SIGHT),
MONSPELL(FIRE_PILLAR,  "divine wrath",    12, MCF_HOSTILE | MCF_SIGHT | MCF_INDIRECT),
MONSPELL(SUMMON_MINION,"summon minion",   12, MCF_HOSTILE | MCF_SIGHT | MCF_INDIRECT),
MONSPELL(ENTOMB,       "summon wall",     12, MCF_HOSTILE | MCF_SIGHT | MCF_INDIRECT | MCF_VS_HERO),
MONSPELL(GEYSER,       "geyser",          13, MCF_HOSTILE | MCF_SIGHT),
MONSPELL(MAKE_POOL,    "make pool",       13, MCF_HOSTILE | MCF_SIGHT),
MONSPELL(AGGRAVATION,  "aggravation",     13, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
...
MONSPELL(TELEPORT,     "teleport",        15, MCF_INDIRECT | MCF_VS_HERO),
MONSPELL(SUMMON_MONS,  "summon nasties",  15, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
...
MONSPELL(CLONE_WIZ,    "simulacrum",      18, MCF_HOSTILE | MCF_INDIRECT | MCF_SIGHT | MCF_VS_HERO),
