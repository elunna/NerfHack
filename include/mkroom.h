...
enum roomtype_types {
    ...
    FUNGUSFARM =  6, /* contains fungus and mold (SLASH'EM) */
    ...
    ANTHOLE    = 14, /* ants (Tom Proudfoot) */
    ARTROOM    = 15, /* art room */
    REALZOO    = 16, /* zoo-like monsters (monkeys, etc.) */
    GIANTCOURT = 17, /* a giant courtroom */
    DRAGONLAIR = 18, /* dragons and $$$ */
