...
CLOAK("cloak of integrity", "feathery cloak",
      0, 1, DISINT_RES, 10, 0, 10, 60,  9, 1,  CLOTH, CLR_CYAN,
                                                         CLOAK_OF_INTEGRITY),
...
FOOD("melon",                10,  1,  5, 0, VEGGY, 100, CLR_BRIGHT_GREEN,
                                                          MELON),
FOOD("pineapple",            10,  2,  5, 0, VEGGY,  85, CLR_YELLOW, PINEAPPLE),
...
SPELL("lightning",        "electric blue",
      P_ATTACK_SPELL,      10,  8, 4, 1, RAY, CLR_BRIGHT_BLUE, SPE_LIGHTNING),
