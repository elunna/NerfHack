...
WEAPON("razor card", NoDes,
       1, 1, 0,  0,   1,   5,  6,  6, 2, (P|S),   -P_SHURIKEN, IRON, HI_METAL,
                                                        RAZOR_CARD),
...
WEAPON("elven spear", "runed spear",
       0, 1, 0, 10,  20,   3,  7,  8, 0, P,   P_SPEAR, COPPER, HI_COPPER,
                                                        ELVEN_SPEAR),
...
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 10,   6,   4,  5,  3, 2, P,   P_DAGGER, COPPER, HI_COPPER,
                                                        ELVEN_DAGGER),
...
WEAPON("axe", NoDes,
       1, 0, 0, 40,  60,   8,  6,  4, 0, S,   P_AXE, IRON, HI_METAL,
                                                        AXE),
WEAPON("clawbone hatchet", NoDes, /* grung, stackable */
       1, 1, 0, 2,  15,   8,  6,  4, 0, S,   P_AXE, CHITON, CLR_WHITE,
                                                        CLAWBONE_HATCHET),
...
WEAPON("elven short sword", "runed short sword",
       0, 0, 0,  2,  20,  10,  8,  8, 1, P,   P_SHORT_SWORD, COPPER, HI_COPPER,
                                                        ELVEN_SHORT_SWORD),
...
WEAPON("orcish scimitar", "crude curved sword",
       0, 0, 0, 15,  40,  15,  6,  8, 0, S,   P_SABER, IRON, CLR_BLACK,
                                                             ORCISH_SCIMITAR),
WEAPON("spineback cutter", "hideous curved sword", /* grung */
       0, 0, 0 , 1,  20,  15,  8,  6, 0, S,   P_SABER, CHITON, CLR_WHITE,
                                                             SPINEBACK_CUTTER),
WEAPON("saber", NoDes,
...
WEAPON("elven broadsword", "runed broadsword",
       0, 0, 0,  4,  45,  10,  6,  6, 0, S,   P_BROAD_SWORD, COPPER, HI_COPPER,
                                                        ELVEN_BROADSWORD),
        /* +d4 small, +1 large */
...
WEAPON("elven long sword", "runed long sword",
       0, 0, 0, 10,  15,  40, 10, 12, 0, S,   P_LONG_SWORD, WOOD, HI_WOOD,
                                                            ELVEN_LONG_SWORD),
WEAPON("orcish long sword", "crude long sword",
       0, 0, 0, 10,  40,  12,  8, 10, 0, S,   P_LONG_SWORD, IRON, CLR_BLACK,
                                                            ORCISH_LONG_SWORD),
...
WEAPON("heavy sword", NoDes,
       1, 0, 1,  15, 500,  50, 6,  8, 0, S,   P_TWO_HANDED_SWORD, MINERAL,
...
WEAPON("mace", NoDes,
       1, 0, 0, 40,  30,   5,  6,  6, 0, B,   P_MACE, IRON, HI_METAL,
                                                        MACE),
        /* +1 small */
WEAPON("skullclaw mace", NoDes, /* grung */
       1, 0, 0,  2,  21,   5,  6,  6, 0, B,   P_MACE, CHITON, CLR_WHITE,
                                                        SKULLCLAW_MACE),
        /* +1 small */
...
HELM("orcish helm", "skull cap",
     0, 0,           0,  6, 1, 30, 10,  9, 0, BONE, CLR_WHITE,
                                                        ORCISH_HELM),
HELM("turtle-shell helm", "turtle shell", /* grung */
     0, 0,           0,  1, 1, 18, 10,  9, 0, CHITON, CLR_WHITE,
                                                        TURTLE_SHELL_HELM),
...
HELM("fedora", NoDes,
     1, 0,           0,  0, 0,  3,  1, 10, 0, CLOTH, CLR_BROWN,
                                                        FEDORA),
HELM("sporecap hood", NoDes, /* grung */
...
ARMOR("elven ring mail", NoDes,
      1, 0, 0,  0, 15, 1, 150, 100,  7, 1,  ARM_SUIT, COPPER, HI_COPPER,
                                                        ELVEN_RING_MAIL),
ARMOR("spider-rib shell", NoDes, /* grung */
...
ARMOR("swampwing vest", NoDes, /* grung */
      1, 0, 0,  0, 4, 3,  30,   5,  9, 1,  ARM_SUIT, LEATHER, HI_LEATHER,
                                                        SWAMPWING_VEST),
ARMOR("snakehide jerkin", NoDes, /* grung */
      1, 0, 0,  0, 4, 0,  14,  10,  10, 0,  ARM_SUIT, LEATHER, CLR_BLACK,
                                                        SNAKEHIDE_JERKIN),
...
GLOVES("rogue's gloves", "fingerless gloves",
       0, 1, SEARCHING, 4, 1, 10, 50, 9, 0,  LEATHER, HI_LEATHER,
                                                        ROGUE_S_GLOVES),
GLOVES("pincer gauntlets", NoDes, /* grung */
       1, 0,           0, 2, 1, 5,  8, 9, 0,  CHITON, CLR_GREEN,
                                                        PINCER_GAUNTLETS),
...
GLOVES("gauntlets of force", "boxing gloves",
       0, 1, STABLE,   4, 1, 10, 50, 9, 0,  LEATHER, HI_LEATHER,
                                                    GAUNTLETS_OF_FORCE),
...
RING("adornment", "spiral",
     ADORNED,                  1, 200, 1, 1, 2, WOOD, HI_WOOD,
                                                        RIN_ADORNMENT),
RING("gain strength", "pyramid",
     0,                        1, 200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                        RIN_GAIN_STRENGTH),
RING("gain constitution", "puzzle",
     0,                        1, 200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                        RIN_GAIN_CONSTITUTION),
RING("gain intelligence", "plain",
     0,                        1, 200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                        RIN_GAIN_INTELLIGENCE),
RING("increase accuracy", "rhombus",
     0,                        1, 200, 1, 1, 4, MINERAL, CLR_RED,
                                                        RIN_INCREASE_ACCURACY),
RING("increase damage", "teardrop",
     0,                        1, 200, 1, 1, 4, MINERAL, CLR_ORANGE,
                                                        RIN_INCREASE_DAMAGE),
RING("protection", "knotted",
...
RING("see invisible", "engagement",
     SEE_INVIS,                1, 200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_SEE_INVISIBLE),
RING("wounding", "ridged",
     WOUNDING,                 1, 200, 1, 0,  8, IRON, HI_METAL,
                                                        RIN_WOUNDING),
RING("nothing", "boring",
     0,                        1, 200, 0, 0,  8, IRON, HI_METAL,
                                                        RIN_NOTHING),
...
RING(NoDes, "cubic",       0, 0, 200, 1, 0, 7, GLASS,    HI_GLASS,   RIN4),
RING(NoDes, "angular",     0, 0, 200, 1, 0, 8, GLASS,    HI_MINERAL, RIN5),
RING(NoDes, "zodiac",      0, 0, 200, 1, 0, 8, GLASS,    HI_MINERAL, RIN6),
RING(NoDes, "dainty",      0, 0, 200, 1, 0, 5, MITHRIL,  HI_SILVER,  RIN7),
RING(NoDes, "tri-band",    0, 0, 200, 1, 0, 3, PLATINUM, HI_METAL,   RIN8),
RING(NoDes, "bezeled",     0, 0, 200, 1, 0, 9, GEMSTONE, CLR_ORANGE, RIN9),
RING(NoDes, "clustered",   0, 0, 200, 1, 0, 6, GEMSTONE, CLR_ORANGE, RIN10),
RING(NoDes, "abstract",    0, 0, 200, 1, 0, 2, CHITON,   CLR_BROWN,  RIN11),
RING(NoDes, "ancient",     0, 0, 200, 1, 0, 7, CHITON,   CLR_BLACK,  RIN12),
RING(NoDes, "gothic",      0, 0, 200, 1, 0, 5, GEMSTONE, CLR_YELLOW, RIN13),
RING(NoDes, "celtic",      0, 0, 200, 1, 0, 7, GEMSTONE, CLR_BLACK,  RIN14),
RING(NoDes, "wavey",       0, 0, 200, 1, 0, 7, GLASS,    CLR_CYAN,   RIN15),
RING(NoDes, "roman",       0, 0, 200, 1, 0, 5, GLASS,    HI_GLASS,   RIN16),
RING(NoDes, "tapered",     0, 0, 200, 1, 0, 1, PLASTIC,  CLR_WHITE,  RIN17),
...
TOOL("magic marker",        NoDes, 1, 0, 1, 1, 5,  2, 500, PLASTIC, CLR_RED,
                                                                MAGIC_MARKER),
/* traps */
...
TOOL("magic whistle",  "whistle", 0, 0, 1, 0, 30, 3, 100, METAL, HI_METAL,
                                                                MAGIC_WHISTLE),
TOOL("cheap flute",        "flute", 0, 0, 0, 0,  4, 5, 12, WOOD, HI_WOOD,
                                                                CHEAP_FLUTE),
...
TOOL("cheap harp",       "harp", 0, 0, 0, 0,  4, 30, 50, WOOD, HI_WOOD,
                                                                CHEAP_HARP),
...
TOOL("bugle",               NoDes, 1, 0, 0, 0,  4, 10, 15, COPPER, HI_COPPER,
                                                                BUGLE),
TOOL("war drum",      "drum", 0, 0, 0, 0,  4, 25, 25, LEATHER, HI_LEATHER,
                                                                WAR_DRUM),
...
#define SCROLL(name,text,mgc,prob,cost,sn) \
    OBJECT(OBJ(name, text),                                           \
           ...
           HI_PAPER, sn)
SCROLL("enchant armor",              "ZELGO MER",  1,  68, 200,
                                                        SCR_ENCHANT_ARMOR),
...
SCROLL("remove curse",             "PRATYAVAYAH",  1,  65, 200,
                                                        SCR_REMOVE_CURSE),
SCROLL("enchant weapon",         "DAIYEN FOOELS",  1,  86, 200,
                                                        SCR_ENCHANT_WEAPON),
...
SCROLL("light",                 "VERR YED HORRE",  1,  90, 200,
                                                        SCR_LIGHT),
SCROLL("teleportation",        "VENZAR BORGAVVE",  1,  50, 200,
                                                        SCR_TELEPORTATION),
SCROLL("gold detection",                 "THARR",  1,  33, 200,
                                                        SCR_GOLD_DETECTION),
SCROLL("food detection",               "YUM YUM",  1,  15, 200,
                                                        SCR_FOOD_DETECTION),
SCROLL("knowledge",                   "POTESTAS",  1, 100,  100,
                                     /* power */        SCR_KNOWLEDGE),
SCROLL("identify",                  "KERNOD WEL",  1,  80,  100,
                                                        SCR_IDENTIFY),
SCROLL("magic mapping",              "ELAM EBOW",  1,  45, 200,
                                                        SCR_MAGIC_MAPPING),
SCROLL("flood",            "EGULED EL IOM SERPA",  1,  35, 200,
                                                        SCR_FLOOD),
SCROLL("amnesia",                   "DUAM XNAHT",  1,  20, 200,
                                                        SCR_AMNESIA),
...
SCROLL("cloning",               "TOYL ENT RUBLE",  1,  15, 200,
                                                        SCR_CLONING),
SCROLL("transmogrify",              "TLON UQBAR",  1,  25, 200,
                                                        SCR_TRANSMOGRIFY),
...
WAND("magic missile",   "steel", 50, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_MAGIC_MISSILE),
WAND("fire",        "hexagonal", 40, 200, 1, RAY, GEMSTONE, CLR_WHITE,
                                                    WAN_FIRE),
...
WAND("draining",      "ceramic", 30, 200, 1, RAY, GLASS,  HI_MINERAL,
                                                    WAN_DRAINING),
/* extra descriptions, shuffled into use at start of new game */
WAND(NoDes,      "spiked", 0, 200, 1, 0, CHITON, HI_METAL,        WAN2),
WAND(NoDes,     "jeweled", 0, 200, 1, 0, IRON, HI_MINERAL,      WAN3),
WAND(NoDes,      "crusty", 0, 200, 1, 0, CHITON, CLR_RED,         WAN4),
