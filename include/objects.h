...
WEAPON("razor card", NoDes,
       1, 1, 0,  0,   1,   5,  6,  6, 2, P,   -P_SHURIKEN, PLASTIC, HI_METAL,
                                                        RAZOR_CARD),
...
RING("withering", "ridged",
     WITHERING,                100, 1, 0,  8, IRON, HI_METAL,
                                                        RIN_WITHERING),
RING("sleeping", "wedding",
     SLEEPY,                   100, 1, 0,  7, GEMSTONE, CLR_WHITE,
                                                        RIN_SLEEPING),
...
POTION("reflection",         "metallic",  1, REFLECTING, 10, 300, CLR_GRAY,
                                                        POT_REFLECTION),
POTION("phasing",               "soupy",  1, PASSES_WALLS, 20, 150, CLR_YELLOW,
                                                        POT_PHASING),
POTION("restore ability",        "pink",  1, 0, 40, 250, CLR_BRIGHT_MAGENTA,
                                                        POT_RESTORE_ABILITY),
...
SCROLL("remove curse",             "PRATYAVAYAH",  1,  65, 300,
                                                        SCR_REMOVE_CURSE),
SCROLL("enchant weapon",         "DAIYEN FOOELS",  1,  50, 200,
                                                        SCR_ENCHANT_WEAPON),
...
SCROLL("food detection",               "YUM YUM",  1,  25, 100,
                                                        SCR_FOOD_DETECTION),
SCROLL("knowledge",                   "POTESTAS",  1,  45,  50,
                                     /* power */        SCR_KNOWLEDGE),
...
SCROLL("punishment",            "VE FORBRYDERNE",  1,  15, 300,
                                                        SCR_PUNISHMENT),
SCROLL("cloning",               "TOYL ENT RUBLE",  1,  10, 300,
                                                        SCR_CLONING),
...
WAND("nothing",           "oak", 25, 500, 0, IMMEDIATE, WOOD, HI_WOOD,
                                                    WAN_NOTHING),
WAND("wonder",       "plastic",  20, 100, 0, IMMEDIATE, PLASTIC, CLR_RED,
                                                    WAN_WONDER),
...
WAND("death",            "long",  5, 500, 1, RAY, IRON, HI_METAL,
                                                    WAN_DEATH),
WAND("lightning",      "curved", 30, 175, 1, RAY, IRON, HI_METAL,
                                                    WAN_LIGHTNING),
WAND("poison gas",  "octagonal", 25, 175, 1, RAY, GLASS, HI_METAL,
                                                    WAN_POISON_GAS),
