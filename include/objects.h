...
WEAPON("clawbone hatchet", NoDes, /* grung, stackable */
       1, 1, 0, 40,  15,   8,  6,  4, 0, S,   P_AXE, BONE, CLR_WHITE,
                                                        CLAWBONE_HATCHET),
...
WEAPON("orcish scimitar", "crude curved sword",
       0, 0, 0, 15,  40,  15,  6,  8, 0, S,   P_SABER, IRON, CLR_BLACK,
                                                             ORCISH_SCIMITAR),
WEAPON("spineback cutter", "hideous curved sword",
       0, 0, 0, 15,  20,  15,  8,  6, 0, S,   P_SABER, BONE, CLR_WHITE,
                                                             SPINEBACK_CUTTER),
WEAPON("saber", NoDes,
...
WEAPON("mace", NoDes,
       1, 0, 0, 40,  30,   5,  6,  6, 0, B,   P_MACE, IRON, HI_METAL,
                                                        MACE),
        /* +1 small */
WEAPON("skullclaw mace", NoDes,
       1, 0, 0, 40,  21,   5,  6,  6, 0, B,   P_MACE, BONE, CLR_WHITE,
                                                        SKULLCLAW_MACE),
        /* +1 small */
...
HELM("orcish helm", "skull cap",
     0, 0,           0,  6, 1, 30, 10,  9, 0, BONE, CLR_WHITE,
                                                        ORCISH_HELM),
HELM("turtle-shell helm", "turtle shell",
     0, 0,           0,  6, 1, 18, 10,  9, 0, BONE, CLR_WHITE,
                                                        TURTLE_SHELL_HELM),
...
ARMOR("scale mail", NoDes,
      1, 0, 0,  0, 72, 5, 240,  45,  6, 1,  ARM_SUIT, IRON, HI_METAL,
                                                        SCALE_MAIL),
ARMOR("giant beetle carapace", NoDes,
      1, 0, 0,  0, 72, 5, 75,  45,  7, 1,  ARM_SUIT, BONE, CLR_BLACK,
                                                        BEETLE_CARAPACE),
...
ARMOR("elven ring mail", NoDes,
      1, 0, 0,  0, 15, 1, 150, 100,  7, 1,  ARM_SUIT, COPPER, HI_COPPER,
                                                        ELVEN_RING_MAIL),
ARMOR("spider-rib shell", NoDes,
      1, 0, 0,  0, 72, 3, 55,  15,  8, 1,  ARM_SUIT, BONE, CLR_WHITE,
                                                        SPIDER_RIB_SHELL),
...
ARMOR("armor", NoDes,
      1, 0, 0,  0, 82, 3,  75,   5,  8, 0,  ARM_SUIT, LEATHER, HI_LEATHER,
                                                        ARMOR),
ARMOR("swampwing vest", NoDes,
      1, 0, 0,  0, 82, 3,  30,   5,  9, 1,  ARM_SUIT, LEATHER, HI_LEATHER,
                                                        SWAMPWING_VEST),
ARMOR("snakehide jerkin", NoDes,
      1, 0, 0,  0, 12, 0,  14,  10,  10, 0,  ARM_SUIT, LEATHER, CLR_BLACK,
                                                        SNAKEHIDE_JERKIN),
...
CLOAK("dragonfly cloak", "iridescent mantelet",
      0, 1,          0,  8, 0,  6, 60,  9, 1,  CLOTH, CLR_BLUE,
                                                        DRAGONFLY_CLOAK),
...
SHIELD("small shield", NoDes,
       1, 0, 0,          0, 6, 0,  30,  3, 9, 0,  WOOD, HI_WOOD,
                                                        SMALL_SHIELD),
SHIELD("crabback shield", NoDes,
       1, 0, 0,          0, 6, 0,  8,  3, 9, 0,  BONE, CLR_WHITE,
                                                        CRABBACK_SHIELD),
SHIELD("elven shield", "blue and green shield",
       0, 0, 0,          0, 2, 0,  25,  7, 8, 0,  WOOD, CLR_GREEN,
                                                        ELVEN_SHIELD),

SHIELD("tortle-shell shield", "blue and green shield",
       0, 0, 0,          0, 2, 0,  15,  7, 8, 0,  BONE, CLR_BLUE,
                                                        TORTLE_SHELL_SHIELD),
...
SHIELD("elven bracers", "runed bracers",
       0, 0, 0,        0, 6, 0,  15,  10, 9, 0, WOOD, CLR_BRIGHT_GREEN,
                                                           ELVEN_BRACERS),
SHIELD("spider-leg wraps", "chitinous bracers",
       0, 0, 0,        0, 6, 0,  15,  10, 9, 0, BONE, CLR_BLACK,
                                                           GRUNG_BRACERS),
...
RING(NoDes, "glass",        0, 0, 200, 1, 0, 7, GLASS,  CLR_CYAN,    RIN15),
RING(NoDes, "crystal",      0, 0, 200, 1, 0, 5, GLASS, HI_GLASS,     RIN16),
RING(NoDes, "plastic",      0, 0, 200, 1, 0, 1, PLASTIC, CLR_WHITE,  RIN17),
...
SCROLL("enchant weapon",         "DAIYEN FOOELS",  1,  15, 200,
                                                        SCR_ENCHANT_WEAPON),
SCROLL("proofing",                      "KA TET",  1,  93, 200,
                                                        SCR_PROOFING),
