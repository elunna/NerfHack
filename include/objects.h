...
WEAPON("clawbone hatchet", NoDes, /* grung, stackable */
       1, 1, 0, 2,  15,   8,  6,  4, 0, S,   P_AXE, BONE, CLR_WHITE,
                                                        CLAWBONE_HATCHET),
...
WEAPON("skullclaw mace", NoDes, /* grung */
       1, 0, 0,  2,  21,   5,  6,  6, 0, B,   P_MACE, BONE, CLR_WHITE,
                                                        SKULLCLAW_MACE),
        /* +1 small */
...
HELM("turtle-shell helm", "turtle shell", /* grung */
     0, 0,           0,  1, 1, 18, 10,  9, 0, BONE, CLR_WHITE,
                                                        TURTLE_SHELL_HELM),
...
ARMOR("giant beetle carapace", NoDes, /* grung */
      1, 0, 0,  0, 2, 5, 75,  45,  7, 1,  ARM_SUIT, BONE, CLR_BLACK,
                                                        BEETLE_CARAPACE),
...
ARMOR("spider-rib shell", NoDes, /* grung */
      1, 0, 0,  0, 3, 3, 55,  15,  8, 1,  ARM_SUIT, BONE, CLR_WHITE,
                                                        SPIDER_RIB_SHELL),
...
SHIELD("crabback shield", NoDes, /* grung */
       1, 0, 0,          0, 1, 0,  8,  3, 9, 0,  BONE, CLR_WHITE,
                                                        CRABBACK_SHIELD),
...
SHIELD("tortle-shell shield", "blue and green shield", /* grung */
       0, 0, 0,          0, 1, 0,  15,  7, 8, 0,  BONE, CLR_BLUE,
                                                        TORTLE_SHELL_SHIELD),
...
SHIELD("spider-leg wraps", "chitinous bracers", /* grung */
       0, 0, 0,        0, 2, 0,  15,  10, 9, 0, BONE, CLR_BLACK,
                                                           GRUNG_BRACERS),
...
GLOVES("pincer gauntlets", NoDes, /* grung */
       1, 0,           0, 2, 1, 5,  8, 9, 0,  VEGGY, CLR_GREEN,
                                                        PINCER_GAUNTLETS),
...
RING(NoDes, "abstract",        0, 0, 200, 1, 0, 2, GEMSTONE, CLR_BROWN, RIN11),
RING(NoDes, "ancient",          0, 0, 200, 1, 0, 7, GEMSTONE, CLR_BLACK, RIN12),
