...
ARMOR("crystal plate mail", NoDes,
      1, 0, 1,  0,  4, 5, 150, 999, 3, 2,   ARM_SUIT, GEMSTONE, CLR_WHITE,
                                                        CRYSTAL_PLATE_MAIL),
...
ARMOR("gnomish suit", "little blue vest",
      0, 0, 0,  0,  1, 0,  50,  40,  8, 0,  ARM_SUIT, CLOTH, CLR_BRIGHT_BLUE,
                                                        GNOMISH_SUIT),
...
BOOTS("gnomish boots", "little black boots",
      0, 0,          0,  1, 2, 10, 16, 9, 0, LEATHER, CLR_BLACK, GNOMISH_BOOTS),
