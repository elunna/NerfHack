...
HELM("oilskin helm", "slippery helm",
     0, 0,           0,  3, 1, 50, 16,  9,  0, CLOTH, CLR_GRAY,
                                                        OILSKIN_HELM),
...
/* Silver scales are coated in silver - see is_silver() */
...
DRGN_ARMR("gray dragon scales",        0, ANTIMAGIC,   700, 9, CLR_GRAY,
                                                        GRAY_DRAGON_SCALES),
DRGN_ARMR("gold dragon scales",        0, 0,           500, 9, HI_GOLD,
                                                        GOLD_DRAGON_SCALES),
/* Silver scales are coated in silver - see is_silver() */
DRGN_ARMR("silver dragon scales",      0, REFLECTING,  700, 9, DRAGON_SILVER,
                                                        SILVER_DRAGON_SCALES),
DRGN_ARMR("shimmering dragon scales",  0, DISPLACED,   700, 8, CLR_CYAN,
...
DRGN_ARMR("white dragon scales",       0, COLD_RES,    500, 9, CLR_WHITE,
                                                        WHITE_DRAGON_SCALES),
DRGN_ARMR("orange dragon scales",      0, SLEEP_RES,   500, 9, CLR_ORANGE,
                                                        ORANGE_DRAGON_SCALES),
DRGN_ARMR("black dragon scales",       0, DISINT_RES,  700, 9, CLR_BLACK,
                                                        BLACK_DRAGON_SCALES),
DRGN_ARMR("blue dragon scales",        0, SHOCK_RES,   500, 9, CLR_BLUE,
                                                        BLUE_DRAGON_SCALES),
DRGN_ARMR("green dragon scales",       0, POISON_RES,  500, 9, CLR_GREEN,
                                                        GREEN_DRAGON_SCALES),
DRGN_ARMR("yellow dragon scales",      0, ACID_RES,    500, 9, CLR_YELLOW,
...
ARMOR("bronze plate mail", NoDes,
      1, 0, 1,  0, 25, 5, 375, 400,  3, 1,  ARM_SUIT, COPPER, HI_COPPER,
                                                        BRONZE_PLATE_MAIL),
...
ARMOR("dwarvish mithril-coat", NoDes,
      1, 0, 0,  0, 10, 1, 200, 240,  4, 2,  ARM_SUIT, MITHRIL, HI_SILVER,
...
ARMOR("gnomish suit", "little blue vest",
      0, 0, 0,  0,  1, 0,  50,  40,  9, 0,  ARM_SUIT, CLOTH, CLR_BRIGHT_BLUE,
                                                        GNOMISH_SUIT),
...
ARMOR("studded leather armor", NoDes,
      1, 0, 0,  0, 72, 3, 150,  15,  7, 0,  ARM_SUIT, LEATHER, HI_LEATHER,
...
ARMOR("leather armor", NoDes,
      1, 0, 0,  0, 82, 3, 100,   5,  8, 0,  ARM_SUIT, LEATHER, HI_LEATHER,
                                                        LEATHER_ARMOR),
...
SHIELD("anti-magic shield", "hide shield",
       0, 1, 0,  ANTIMAGIC, 2, 0,  25, 75, 8, 0,  LEATHER, CLR_ORANGE,
                                                        ANTI_MAGIC_SHIELD),
SHIELD("shield of integrity", "embossed shield",
       0, 1, 0, DISINT_RES, 3, 0,  50, 50, 8, 0,  WOOD, CLR_YELLOW,
                                                        SHIELD_OF_INTEGRITY),
...
RING("adornment", "wooden",
     ADORNED,                  200, 1, 1, 2, WOOD, HI_WOOD, RIN_ADORNMENT),
RING("gain strength", "granite",
     0,                        200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                            RIN_GAIN_STRENGTH),
RING("gain constitution", "opal",
     0,                        200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                        RIN_GAIN_CONSTITUTION),
RING("increase accuracy", "clay",
     0,                        200, 1, 1, 4, MINERAL, CLR_RED,
                                                        RIN_INCREASE_ACCURACY),
RING("increase damage", "coral",
     0,                        200, 1, 1, 4, MINERAL, CLR_ORANGE,
                                                        RIN_INCREASE_DAMAGE),
RING("protection", "black onyx",
     PROTECTION,               200, 1, 1, 7, MINERAL, CLR_BLACK,
                                                        RIN_PROTECTION),
...
RING("searching", "tiger eye",
     SEARCHING,                200, 1, 0,  6, GEMSTONE, CLR_BROWN,
                                                        RIN_SEARCHING  ),
RING("stealth", "jade",
     STEALTH,                  200, 1, 0,  6, GEMSTONE, CLR_GREEN,
                                                        RIN_STEALTH),
RING("sustain ability", "bronze",
     FIXED_ABIL,               200, 1, 0,  4, COPPER, HI_COPPER,
                                                        RIN_SUSTAIN_ABILITY),
RING("levitation", "agate",
     LEVITATION,               200, 1, 0,  7, GEMSTONE, CLR_RED,
                                                        RIN_LEVITATION),
RING("hunger", "topaz",
     HUNGER,                   200, 1, 0,  8, GEMSTONE, CLR_CYAN,
                                                        RIN_HUNGER),
RING("aggravate monster", "sapphire",
     AGGRAVATE_MONSTER,        200, 1, 0,  9, GEMSTONE, CLR_BLUE,
                                                        RIN_AGGRAVATE_MONSTER),
RING("conflict", "ruby",
     CONFLICT,                 200, 1, 0,  9, GEMSTONE, CLR_RED,
                                                        RIN_CONFLICT),
RING("warning", "diamond",
     WARNING,                  200, 1, 0, 10, GEMSTONE, CLR_WHITE,
                                                        RIN_WARNING),
RING("poison resistance", "pearl",
     POISON_RES,               200, 1, 0,  4, BONE, CLR_WHITE,
                                                        RIN_POISON_RESISTANCE),
RING("fire resistance", "iron",
     FIRE_RES,                 200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_FIRE_RESISTANCE),
RING("cold resistance", "brass",
     COLD_RES,                 200, 1, 0,  4, COPPER, HI_COPPER,
                                                        RIN_COLD_RESISTANCE),
RING("shock resistance", "copper",
     SHOCK_RES,                200, 1, 0,  3, COPPER, HI_COPPER,
...
RING("teleport control", "gold",
     TELEPORT_CONTROL,         200, 1, 0,  3, GOLD, HI_GOLD,
                                                        RIN_TELEPORT_CONTROL),
RING("polymorph", "ivory",
     POLYMORPH,                200, 1, 0,  4, BONE, CLR_WHITE,
                                                        RIN_POLYMORPH),
RING("polymorph control", "emerald",
     POLYMORPH_CONTROL,        200, 1, 0,  8, GEMSTONE, CLR_BRIGHT_GREEN,
                                                        RIN_POLYMORPH_CONTROL),
RING("invisibility", "wire",
     INVIS,                    200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_INVISIBILITY),
RING("see invisible", "engagement",
     SEE_INVIS,                200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_SEE_INVISIBLE),
RING("withering", "ridged",
     WITHERING,                200, 1, 0,  8, IRON, HI_METAL,
                                                        RIN_WITHERING),
RING("sleeping", "wedding",
     SLEEPY,                   200, 1, 0,  7, GEMSTONE, CLR_WHITE,
                                                        RIN_SLEEPING),
RING("carrying", "glittery",
     0,                        200, 1, 1,  7, GEMSTONE, CLR_WHITE,
                                                        RIN_CARRYING),
RING("protection from shape changers", "shiny",
     PROT_FROM_SHAPE_CHANGERS, 200, 1, 0,  5, IRON, CLR_BRIGHT_CYAN,
...
POTION("see invisible",       "magenta",  1, SEE_INVIS, 40, 200, CLR_MAGENTA,
                                                        POT_SEE_INVISIBLE),
POTION("healing",              "amber",  1, 0, 115, 20, CLR_MAGENTA,
                                                        POT_HEALING),
POTION("extra healing",          "puce",  1, 0, 45, 200, CLR_RED,
                                                        POT_EXTRA_HEALING),
POTION("gain level",            "milky",  1, 0, 20, 200, CLR_WHITE,
                                                        POT_GAIN_LEVEL),
...
SCROLL("taming",                   "PRIRUTSENIE",  1,  15, 200,
                                                        SCR_TAMING),
SCROLL("genocide",                  "ELBIB YLOH",  1,  15, 200,
                                                        SCR_GENOCIDE),
...
SPELL("drain life",      "velvet",
      P_ATTACK_SPELL,      10,  2, 2, 1, RAY, CLR_MAGENTA,
                                                        SPE_DRAIN_LIFE),
...
SPELL("identify",        "bronze",
      P_DIVINATION_SPELL,  20,  6, 5, 1, NODIR, HI_COPPER,
                                                        SPE_IDENTIFY),
...
WAND("nothing",           "oak", 25, 200, 0, IMMEDIATE, WOOD, HI_WOOD,
                                                    WAN_NOTHING),
WAND("wonder",        "plastic", 20, 200, 0, IMMEDIATE, PLASTIC, CLR_RED,
                                                    WAN_WONDER),
...
WAND("lightning",      "curved", 30, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_LIGHTNING),
WAND("poison gas",  "octagonal", 25, 200, 1, RAY, GLASS, HI_METAL,
                                                    WAN_POISON_GAS),
 ...
 * (inclusive).
 */
ROCK("luckstone", "gray",  0,  10,  25, 60, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY,
                                                                    LUCKSTONE),
ROCK("healthstone", "gray",0 ,  8,  25, 60, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY,
                                                                  HEALTHSTONE),
ROCK("whetstone", "gray",  0,   3,  25, 45, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY,
                                                                    WHETSTONE),
ROCK("foulstone", "gray",  0,   3,  25,  0, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY,
                                                                    FOULSTONE),
ROCK("loadstone", "gray",  0,  10, 500,  1, 3, 3, 1, 10, 6, MINERAL, CLR_GRAY,
                                                                    LOADSTONE),
ROCK("touchstone", "gray", 0,   8,  25, 45, 3, 3, 1, 10, 6, MINERAL, CLR_GRAY,
                                                                  TOUCHSTONE),
