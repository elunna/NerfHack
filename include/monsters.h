 ...
 */
    ...
    MON(NAM("giant fly"), S_ANT,
        ...
        M2_HOSTILE | M2_WANDER, 0, M4_VULNERABLE_ACID | M4_RES_PIERCE,
    ...
    MON(NAM("giant beetle"), S_ANT,
        ...
        0, M4_VULNERABLE_ACID | M4_RES_SLASH,
    ...
    MON(NAM("acid blob"), S_BLOB,
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_ACID,
        M2_WANDER | M2_NEUTER, 0, M4_VULNERABLE_FIRE | M4_RES_BLUNT,
    ...
    MON(NAM("quivering blob"), S_BLOB,
        ...
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, M4_VULNERABLE_FIRE | M4_RES_BLUNT,
    ...
    MON(NAM("gelatinous cube"), S_BLOB,
     ...
     MON(NAM("jiggling blob"), S_BLOB,
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_WANDER | M2_HOSTILE | M2_NEUTER, M3_JUMPER, M4_VULNERABLE_FIRE | M4_RES_BLUNT,
    ...
    MON(NAM("lava blob"), S_BLOB,
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, M4_VULNERABLE_COLD | M4_RES_BLUNT,
    ...
    MON(NAM("pyrolisk"), S_COCKATRICE,
        ...
        MR_POISON | MR_FIRE,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE | M1_OVIPAROUS | M1_FLY,
        M2_HOSTILE, M3_INFRAVISIBLE, M4_VULNERABLE_COLD | M4_VULN_BLUNT,
    ...
    MON(NAM("blue jelly"), S_JELLY,
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VULNERABLE_FIRE | M4_VULN_SLASH | M4_RES_BLUNT,
    ...
    MON(NAM("iron piercer"), S_PIERCER,
        ...
        M1_CLING | M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_CARNIVORE
            | M1_NOTAKE | M1_MINDLESS,
        M2_HOSTILE, M3_ACCURATE, M4_VULNERABLE_ACID | M4_VULN_BLUNT,
    ...
    MON(NAM("maggot"), S_WORM,
        ...
        SIZ(10, 10, MS_SILENT, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE | M1_NOTAKE,
        M2_HOSTILE, 0, M4_VULNERABLE_FIRE | M4_VULN_BLUNT,
    ...
    MON(NAM("gold dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC
            | M2_STALK, M3_INFRAVISIBLE, M4_VULNERABLE_COLD | M4_RES_SLASH,
    ...
    MON(NAM("red dragon"), S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC
            | M2_STALK,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_BERSERK, M4_VULNERABLE_COLD | M4_RES_SLASH,
    ...
    MON(NAM("white dragon"), S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC
            | M2_STALK,
        0, M4_VULNERABLE_FIRE | M4_RES_SLASH,
    ...
    MON(NAM("lichen"), S_FUNGUS,
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VULNERABLE_FIRE | M4_RES_PIERCE,
    ...
    */
    ...
    MON(NAM("worm that walks"), S_LICH,
        ...
        M4_VULNERABLE_FIRE | M4_VULN_BLUNT,
    ...
    MON(NAM("kobold mummy"), S_MUMMY,
        ...
        M4_VULNERABLE_FIRE | M4_VULN_SLASH | M4_RES_PIERCE | M4_RES_BLUNT,
    ...
    MON(NAM("gray ooze"), S_PUDDING,
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VULNERABLE_ELEC | M4_VULN_SLASH | M4_RES_BLUNT,
    ...
    MON(NAM("skeleton"), S_ZOMBIE,
        ...
        M3_INFRAVISION, M4_VULNERABLE_FIRE | M4_VULN_BLUNT,
    ...
    MON(NAM("straw golem"), S_GOLEM,
        ...
        0, M4_VULNERABLE_FIRE | M4_RES_PIERCE,
    ...
    MON(NAM("rope golem"), S_GOLEM,
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER,
        0, M4_VULNERABLE_FIRE | M4_VULN_SLASH,
    ...
    MON(NAM("flesh golem"), S_GOLEM,
        ...
        0, M4_VULNERABLE_ACID | M4_VULN_SLASH,
    ...
    MON(NAM("iron golem"), S_GOLEM,
        ...
        0, M4_VULNERABLE_ACID | M4_VULN_BLUNT,
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON(NAM("piranha"), S_EEL,
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOLIMBS | M1_CARNIVORE
            | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, 0, M4_VULNERABLE_ELEC | M4_VULN_PIERCE,
    ...
    MON(NAM("giant eel"), S_EEL,
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_SLITHY | M1_NOLIMBS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, M3_INFRAVISIBLE, M4_VULNERABLE_ELEC | M4_VULN_PIERCE,
    ...
    MON(NAM("kraken"), S_EEL,
        ...
        M4_VULNERABLE_ELEC | M4_VULN_PIERCE,
