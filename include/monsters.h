 ...
 */
    ...
    MON("weretiger", S_FELINE,                                  /* Slash'EM */
        ...
        M3_INFRAVISIBLE | M3_JUMPER, 9, CLR_ORANGE, WERETIGER),
    ...
    MON("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_BERSERK, 4, CLR_RED, DWARF),
    ...
    MON("baby red dragon", S_DRAGON, LVL(4, 9, 2, 10, -4), (G_GENO | 2),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        M3_INFRAVISIBLE, 5, CLR_RED, BABY_RED_DRAGON),
    ...
    MON3("gnome lord", "gnome lady", "gnome leader",
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ACCURATE, 4, CLR_BLUE, GNOME_LEADER),
    ...
    MON("elf", S_HUMAN, LVL(0, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_ACCURATE, 1, HI_DOMESTIC, ELF),
