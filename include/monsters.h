 ...
 */
    ...
    MON(NAM("migo drone"), S_ANT,
     ...
     MON(NAM("migo warrior"), S_ANT,
        LVL(8, 20, -3, 30, -7), (G_GENO | G_SGROUP | 4),
        A(ATTK(AT_STNG, AD_DRST, 1, 3),
    ...
    MON(NAM("water hulk"), S_UMBER,
        ...
        A(ATTK(AT_BITE, AD_PHYS, 4, 5),
          ...
          ATTK(AT_GAZE, AD_CONF, 0, 0),
          NO_ATTK, NO_ATTK),
        SIZ(1200, 500, MS_SILENT, MZ_HUGE), 0, 0,
        M1_SWIM | M1_TUNNEL | M1_CARNIVORE | M1_SEE_INVIS,
    ...
    MON(NAM("hunger hulk"), S_UMBER,
        ...
        A(ATTK(AT_TUCH, AD_HNGY, 3, 4),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(1200, 0, MS_SILENT, MZ_HUGE), 0, 0,
    ...
    MON(NAM("slumber hulk"), S_UMBER,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(1200, 500, MS_SILENT, MZ_LARGE), MR_SLEEP, MR_SLEEP,
    ...
    MON(NAM("gorgon hulk"), S_UMBER,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4),
          ...
          ATTK(AT_GAZE, AD_STON, 0, 0),
          NO_ATTK, NO_ATTK),
        SIZ(1200, 500, MS_SILENT, MZ_LARGE), MR_STONE, MR_STONE,
        M1_TUNNEL | M1_CARNIVORE | M1_SEE_INVIS,
    ...
    MON(NAM("ghoul queen"), S_ZOMBIE,
        ...
        M3_INFRAVISION,
        MH_UNDEAD, 20, CLR_BRIGHT_MAGENTA, GHOUL_QUEEN),
    /*
     * golems
     */
