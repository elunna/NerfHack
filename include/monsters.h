 ...
 */
    ...
    MON("soldier ant", S_ANT, LVL(3, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M2_HOSTILE | M2_FLANK, 0, 6, CLR_BLUE, SOLDIER_ANT),
    ...
    MON("giant praying mantis", S_ANT, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_FLANK, 0, 9, CLR_GREEN, GIANT_PRAYING_MANTIS),
    ...
    MON("coyote", S_DOG, LVL(1, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE, 2, CLR_BROWN, COYOTE),
    MON("werejackal", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
        A(ATTK(AT_NONE, AD_PLYS, 0, 35), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
    ...
    MON("glowing eye", S_EYE, LVL(5, 3, 4, 0, 0), (G_NOHELL | G_GENO | 1),
        ...
        M2_HOSTILE | M2_NEUTER | M2_WANDER, 0, 7, CLR_YELLOW, GLOWING_EYE),
    ...
    MON("jaguar", S_FELINE, LVL(4, 15, 6, 0, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_JUMPER, 6, CLR_BROWN, JAGUAR),
    MON("lynx", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION  | M3_JUMPER, 7, CLR_CYAN, LYNX),
    MON("panther", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_JUMPER, 7, CLR_BLACK, PANTHER),
    ...
    MON("weretiger", S_FELINE,                                  /* Slash'EM */
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_JUMPER, 9, CLR_ORANGE, WERETIGER),
    ...
    MON("hobbit", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
        ...
        M2_COLLECT | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION, 2, CLR_GREEN, HOBBIT),
    ...
    MON("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_BERSERK, 4, CLR_RED, DWARF),
    ...
    MON3("dwarf lord", "dwarf lady", "dwarf leader",
        ...
        M2_DWARF | M2_STRONG | M2_LORD | M2_GREEDY | M2_JEWELS
            | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_BERSERK, 6, CLR_BLUE, DWARF_LEADER),
    MON3("dwarf king", "dwarf queen", "dwarf ruler",
        ...
        M2_DWARF | M2_STRONG | M2_PRINCE | M2_GREEDY | M2_JEWELS
            | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_BERSERK | M3_ACCURATE, 8, HI_LORD, DWARF_RULER),
    ...
    MON("master mind flayer", S_HUMANOID, LVL(13, 12, 0, 90, -8),
        ...
        MASTER_MIND_FLAYER),
    MON("alhoon", S_HUMANOID, LVL(26, 15, -6, 90, -15),
    ...
    MON("tengu", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
        ...
        7, CLR_CYAN, TENGU),
    MON("redcap", S_IMP, LVL(10, 15, 2, 30, 7), (G_GENO | 1 | G_NOCORPSE),
    ...
    MON("kobold shaman", S_KOBOLD, LVL(5, 6, 6, 10, -4), (G_GENO | 1),
    ...
    MON("goblin", S_ORC, LVL(0, 6, 10, 0, -3), (G_GENO | G_SGROUP | 2),
        ...
        M2_ORC | M2_COLLECT | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION,
        1, CLR_GRAY, GOBLIN),
    MON("hobgoblin", S_ORC, LVL(1, 9, 10, 0, -4), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 200, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_ORC | M2_STRONG | M2_COLLECT | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION,
    ...
    MON("orc", S_ORC, LVL(1, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        ...
        M3_INFRAVISIBLE, 3, CLR_RED, ORC),
    MON("hill orc", S_ORC, LVL(2, 9, 10, 0, -4), (G_GENO | G_LGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 200, MS_ORC, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_ORC | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, 4, CLR_YELLOW, HILL_ORC),
    ...
    MON("orc shaman", S_ORC, LVL(4, 9, 5, 10, -5), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 300, MS_ORC, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_ORC | M2_GREEDY | M2_JEWELS | M2_MAGIC | M2_FLANK,
    ...
    MON("rock piercer", S_PIERCER, LVL(3, 1, 3, 0, 0), (G_GENO | 4),
        ...
        M2_HOSTILE, M3_ACCURATE, 4, CLR_GRAY, ROCK_PIERCER),
    ...
    MON("diamond piercer", S_PIERCER, LVL(8, 1, 0, 0, 0), (G_GENO | 1),
        ...
        M1_CLING | M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_CARNIVORE
            | M1_NOTAKE | M1_MINDLESS,
        M2_HOSTILE, M3_ACCURATE, 12, CLR_BLUE, DIAMOND_PIERCER),
    /*
     * quadrupeds
     */
    ...
    MON("mumak", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE | M3_BERSERK, 7, CLR_GRAY,
        MUMAK),
    ...
    MON("landshark", S_QUADRUPED, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG | M3_JUMPER, 0, 9, CLR_GRAY, LANDSHARK),
    ...
    MON("rabid rat", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_NOTAME, 4, CLR_BROWN, RABID_RAT),
    ...
    MON("jumping spider", S_SPIDER,
        ...
        M2_HOSTILE, M3_JUMPER, 5, CLR_CYAN, JUMPING_SPIDER),
    ...
    MON("scorpion", S_SPIDER, LVL(5, 15, 3, 0, 0), (G_GENO | 2),
        ...
        M1_CONCEAL | M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS
            | M1_CARNIVORE,
        M2_HOSTILE, M3_ACCURATE, 8, CLR_RED, SCORPION),
    /*
     * trappers, lurkers, &c
     ...
     */
    MON("lurker above", S_TRAPPER, LVL(10, 6, 0, 0, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_WRAP, 1, 8), ATTK(AT_ENGL, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("trapper", S_TRAPPER, LVL(12, 6, 0, 0, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_WRAP, 1, 12), ATTK(AT_ENGL, AD_PHYS, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 350, MS_SILENT, MZ_HUGE), 0, 0,
    ...
    MON("will-o'-the-wisp", S_LIGHT,
        ...
        M3_INFRAVISIBLE, 7, CLR_WHITE, WILL_O__THE_WISP),
    /*
     * zruty
     */
    MON("zruty", S_ZRUTY, LVL(9, 8, 3, 0, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE | M3_JUMPER | M3_BERSERK, 11, CLR_BROWN, ZRUTY),
    /*
    ...
    MON("bat", S_BAT, LVL(0, 22, 8, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M2_WANDER, M3_INFRAVISIBLE, 2, CLR_BROWN, BAT),
    ...
    MON("zoo bat", S_BAT, LVL(3, 20, 7, 0, 0), (G_GENO | G_LGROUP | 3),
        ...
        M3_INFRAVISIBLE, 5, CLR_CYAN, ZOO_BAT),
    ...
    MON("byakhee", S_BAT,
        ...
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_STNG, AD_STUN, 1, 6), 
          NO_ATTK, NO_ATTK),
    ...
    MON("nightgaunt", S_BAT,                                    /* Slash'EM */
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 19, HI_LORD, NIGHTGAUNT),
    /*
     * Centaurs
     */
    MON("plains centaur", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_JUMPER | M3_ACCURATE, 6, CLR_BROWN, PLAINS_CENTAUR),
    MON("forest centaur", S_CENTAUR, LVL(5, 18, 3, 10, -1), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_JUMPER | M3_ACCURATE, 8, CLR_GREEN, FOREST_CENTAUR),
    MON("mountain centaur", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY
            | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_JUMPER | M3_ACCURATE, 9, CLR_CYAN, MOUNTAIN_CENTAUR),
    /*
     * Dragons
     */
     ...
     */
    MON("baby gray dragon", S_DRAGON, LVL(4, 9, 2, 10, 4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        0, 5, CLR_GRAY, BABY_GRAY_DRAGON),
    MON("baby gold dragon", S_DRAGON, LVL(4, 9, 2, 10, 4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        M3_INFRAVISIBLE, 5, HI_GOLD, BABY_GOLD_DRAGON),
    MON("baby silver dragon", S_DRAGON, LVL(4, 9, 2, 40, 4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, DRAGON_SILVER, BABY_SILVER_DRAGON),
#if 0 /* DEFERRED */
    /* [see "shimmering dragon" below] */
    MON("baby shimmering dragon", S_DRAGON,
        LVL(4, 9, -4, 10, 4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, CLR_CYAN, BABY_SHIMMERING_DRAGON),
#endif
    MON("baby red dragon", S_DRAGON, LVL(4, 9, 2, 10, -4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_FIRE, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        M3_INFRAVISIBLE | M3_BERSERK, 5, CLR_RED, BABY_RED_DRAGON),
    MON("baby white dragon", S_DRAGON, LVL(4, 9, 2, 10, -4), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_COLD, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, CLR_WHITE, BABY_WHITE_DRAGON),
    MON("baby orange dragon", S_DRAGON, LVL(4, 9, 2, 10, -5), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_SLEEP, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, CLR_ORANGE, BABY_ORANGE_DRAGON),
    MON("baby black dragon", S_DRAGON, LVL(4, 9, 2, 10, -6), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby blue dragon", S_DRAGON, LVL(4, 12, 2, 10, -7), (G_GENO | 2),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, CLR_BLUE, BABY_BLUE_DRAGON),
    MON("baby green dragon", S_DRAGON, LVL(4, 9, 2, 10, -6), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_POISON, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 5, CLR_GREEN, BABY_GREEN_DRAGON),
    MON("baby yellow dragon", S_DRAGON, LVL(4, 9, 2, 10, -7), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("red dragon", S_DRAGON, LVL(18, 20, -4, 20, -4), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC
            | M2_STALK,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_BERSERK, 25, CLR_RED, RED_DRAGON),
    ...
    MON("gnome", S_GNOME, LVL(1, 6, 10, 4, 0), (G_GENO | G_SGROUP | 1),
        ...
        M2_GNOME | M2_COLLECT, M3_INFRAVISIBLE,
        3, CLR_BROWN, GNOME),
    MON3("gnome lord", "gnome lady", "gnome leader",
        ...
        M2_GNOME | M2_LORD | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 4, CLR_BLUE, GNOME_LEADER),
    ...
    MON3("gnome king", "gnome queen", "gnome ruler",
        ...
        M2_GNOME | M2_PRINCE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, 6, HI_LORD, GNOME_RULER),
    /*
     * giant Humanoids
     */
    ...
    MON("titan", S_GIANT, LVL(17, 18, -6, 70, 9), (1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ACCURATE, 20, CLR_MAGENTA, TITAN),
     ...
     * Kops
     */
    MON("Keystone Kop", S_KOP, LVL(3, 10, 10, 10, 9), (G_LGROUP | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Kop Sergeant", S_KOP, LVL(5, 10, 10, 10, 10), (G_SGROUP | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_CARNIVORE,
        M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, 4, CLR_BLUE, KOP_SERGEANT),
    MON("Kop Lieutenant", S_KOP, LVL(6, 12, 10, 20, 11), (G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_CARNIVORE,
    ...
    MON("Kop Kaptain", S_KOP, LVL(8, 12, 10, 20, 12), (G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_CARNIVORE,
        M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 6, HI_LORD, KOP_KAPTAIN),
    /*
     * Liches
     */
    ...
    MON("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        ...
        M2_UNDEAD | M2_HOSTILE | M2_ELF, M3_INFRAVISION | M3_ACCURATE,
    ...
    MON("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        ...
        ETTIN_MUMMY),
    MON("adherer", S_MUMMY, LVL(7, 12, 4, 30, -5),
         (G_GENO | G_NOCORPSE | 1),
         A(ATTK(AT_CLAW, AD_STCK, 2, 4), ATTK(AT_CLAW, AD_WTHR, 4, 4),
           ATTK(AT_NONE, AD_DSRM, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
         SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
         MR_COLD | MR_SLEEP | MR_POISON, 0,
         M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
         M2_HOSTILE | M2_UNDEAD, M3_INFRAVISION, 10, CLR_YELLOW, ADHERER),
    ...
    MON("troll mummy", S_MUMMY,
        ...
        M2_HOSTILE | M2_STRONG | M2_STALK | M2_JEWELS | M2_UNDEAD,
        M3_INFRAVISION, 11, CLR_BROWN, TROLL_MUMMY),  
    ...
    MON("ha-naga", S_NAGA, LVL(20, 18, -4, 70, -2), (G_GENO | G_HELL | 1),
        A(ATTK(AT_SPIT, AD_DRST, 3, 6), ATTK(AT_BITE, AD_PLYS, 2, 3),
          ATTK(AT_MAGC, AD_SPEL, 5, 6), ATTK(AT_HUGS, AD_PHYS, 4, 8),
          NO_ATTK, NO_ATTK),
        SIZ(3200, 800, MS_MUMBLE, MZ_GIGANTIC), 
        MR_POISON | MR_ACID | MR_FIRE, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_OVIPAROUS | M1_POIS
            | M1_OMNIVORE | M1_FLY,
        M2_STRONG | M2_FEMALE, 0, 24, CLR_BRIGHT_MAGENTA, HA_NAGA),
    /*
     * Ogres
     */
    MON("ogre", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_BERSERK, 7, CLR_BROWN, OGRE),
    ...
    MON("alchemist", S_QUANTMECH, LVL(9, 12, 3, 10, 0), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE, 11, CLR_RED, ALCHEMIST),
    /*
    ...
    MON("cobra", S_SNAKE, LVL(6, 18, 2, 0, 0), (G_GENO | 1),
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, M3_ACCURATE, 10, CLR_BLUE, COBRA),
    /*
     * Trolls
     */
    ...
    MON("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ACCURATE, 16, HI_LORD, OLOG_HAI),
    /*
     * Umber hulk
     */
    ...
    MON("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        ...
        M3_WAITFORU | M3_WANTSCAND | M3_INFRAVISIBLE | M3_ACCURATE,
    ...
    MON("wraith", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_GENO | 2),
        ...
        M2_UNDEAD | M2_HOSTILE, 0, 8, CLR_BLACK,
        WRAITH),
    ...
    MON("sasquatch", S_YETI, LVL(7, 15, 6, 0, 2), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_BERSERK, 9, CLR_GRAY, SASQUATCH),
    /*
     * Zombies
     */
    ...
    MON("elf zombie", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        ...
        M3_INFRAVISION | M3_ACCURATE, 4, CLR_GREEN, ELF_ZOMBIE),
    ...
    MON("skeleton", S_ZOMBIE, LVL(12, 8, 2, 0, 0), (G_NOCORPSE | G_NOGEN),
    ...
    MON("clay golem", S_GOLEM, LVL(11, 7, 5, 40, 0), (G_NOCORPSE | 1),
    ...
    MON("stone golem", S_GOLEM, LVL(14, 6, 2, 50, 0), (G_NOCORPSE | 1),
    ...
    MON("weretiger", S_HUMAN,
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE | M2_HUMAN | M2_COLLECT,
        M3_INFRAVISIBLE, 8, CLR_ORANGE, HUMAN_WERETIGER),
    ...
    MON("elf", S_HUMAN, LVL(0, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        ...
        M3_INFRAVISIBLE | M3_ACCURATE, 1, HI_DOMESTIC, ELF),
    ...
    MON("Green-elf", S_HUMAN, LVL(5, 12, 10, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF
            | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE,
    ...
    MON3("elf-lord", "elf-lady", "elf-noble",
        ...
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_ELF | M2_STRONG | M2_LORD | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE,
    ...
    MON3("Elvenking", "Elvenqueen", "elven monarch",
        ...
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_ELF | M2_STRONG | M2_PRINCE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE,
    ...
    MON("guard", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MERC | M2_PEACEFUL | M2_STRONG
            | M2_COLLECT | M2_FLANK,
    ...
    MON("soldier", S_HUMAN, LVL(7, 10, 10, 10, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M3_INFRAVISIBLE | M3_ACCURATE, 8, CLR_GRAY, SOLDIER),
    MON("sergeant", S_HUMAN, LVL(9, 11, 9, 20, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                            | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 10, CLR_RED, SERGEANT),
    MON("nurse", S_HUMAN, LVL(11, 6, 0, 0, 0), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_ACCURATE, 13, HI_DOMESTIC, NURSE),
    MON("lieutenant", S_HUMAN, LVL(11, 12, 8, 30, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                  | M2_LORD | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 12, CLR_GREEN, LIEUTENANT),
    MON("captain", S_HUMAN, LVL(13, 13, 7, 40, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                | M2_PRINCE | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 14, CLR_BLUE, CAPTAIN),
    ...
    MON("watch captain", S_HUMAN, LVL(10, 10, 10, 15, -4),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                            | M2_PEACEFUL | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_ACCURATE, 12, CLR_GREEN, WATCH_CAPTAIN),
    ...
    MON("Medusa", S_HUMAN, LVL(20, 12, 2, 50, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION, 25, 
        CLR_BRIGHT_GREEN, MEDUSA),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("barbed devil", S_DEMON, LVL(8, 12, 0, 35, 8),
        ...
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
        M1_POIS | M1_THICK_HIDE, M2_DEMON | M2_STALK | M2_HOSTILE
            | M2_NASTY | M2_FLANK,
    ...
    MON("balrog", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
        ...
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_BERSERK, 20, CLR_RED, BALROG),
    ...
    MON3("merman", "mermaid", "merfolk", S_EEL, /* SpliceHack + SlashTHEM */
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_MAGENTA, MERMAID),
    MON("kraken", S_EEL, LVL(20, 3, 6, 0, -3), (G_GENO | G_NOGEN),
        ...
        KRAKEN),
    MON("thing from below", S_EEL, LVL(30, 12, 6, 95, -3), (G_GENO | G_NOGEN),
    ...
    MON("Scorpius", S_SPIDER, LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_ACCURATE, 17, HI_LORD, SCORPIUS),
    ...
    MON("ninja", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_ACCURATE, 7, HI_DOMESTIC, NINJA),
