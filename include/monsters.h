 ...
 */
    ...
    MON("baby gray dragon", S_DRAGON, LVL(12, 9, 2, 10, 4), G_GENO,
        ...
        0, 13, CLR_GRAY, BABY_GRAY_DRAGON),
    MON("baby gold dragon", S_DRAGON, LVL(12, 9, 2, 10, 4), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        M3_INFRAVISIBLE, 13, HI_GOLD, BABY_GOLD_DRAGON),
    MON("baby silver dragon", S_DRAGON, LVL(12, 9, 2, 10, 4), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, DRAGON_SILVER, BABY_SILVER_DRAGON),
#if 0 /* DEFERRED */
    ...
    MON("baby shimmering dragon", S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_CYAN, BABY_SHIMMERING_DRAGON),
#endif
    MON("baby red dragon", S_DRAGON, LVL(12, 9, 2, 10, -4), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        M3_INFRAVISIBLE | M3_BERSERK, 13, CLR_RED, BABY_RED_DRAGON),
    MON("baby white dragon", S_DRAGON, LVL(12, 9, 2, 10, -4), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_COLD, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_WHITE, BABY_WHITE_DRAGON),
    MON("baby orange dragon", S_DRAGON, LVL(12, 9, 2, 10, -5), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_ORANGE, BABY_ORANGE_DRAGON),
    MON("baby black dragon", S_DRAGON, LVL(12, 9, 2, 10, -6), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_BLACK, BABY_BLACK_DRAGON),
    MON("baby blue dragon", S_DRAGON, LVL(12, 9, 2, 10, -7), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_ELEC, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_BLUE, BABY_BLUE_DRAGON),
    MON("baby green dragon", S_DRAGON, LVL(12, 9, 2, 10, -6), G_GENO,
        ...
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_GREEN, BABY_GREEN_DRAGON),
    MON("baby yellow dragon", S_DRAGON, LVL(12, 9, 2, 10, -7), G_GENO,
        ...
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_STALK,
        0, 13, CLR_YELLOW, BABY_YELLOW_DRAGON),
