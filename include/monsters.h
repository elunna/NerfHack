 ...
 */
    ...
    MON(NAM("baluchitherium"), S_QUADRUPED,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 5, 12),
          ATTK(AT_CLAW, AD_PHYS, 5, 12),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
