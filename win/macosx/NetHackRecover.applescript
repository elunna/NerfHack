...
if not canceled then
	...
	considering case
		--set lastpos to offset of "/nerfhackdir" in mpath
		--set lastpos to lastpos + (length of "/nerfhackdir")
		--set rawpath to (get text 1 through lastpos of mpath) & "/recover.pl"
		--set safepath to the quoted form of rawpath
		set safepath to the quoted form of "/Library/Nethack/nerfhackdir/recover.pl"
	end considering
