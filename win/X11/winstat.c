...
#define F_PHASE     47 /* replaces F_ICY */
#define F_RABID     48 /* replaces F_BUSY */
#define F_PARALYZED 49
#define F_SLEEPING 50
#define F_UNCONSCIOUS 51
#define F_IRON     52
#define F_SLIPPERY 53
#define F_WITHER   54 /* replaces F_SUBMERGED */
    ...
    unsigned long *colormasks UNUSED)
{
    ...
    static const struct mask_to_ff {
        ...
        { BL_MASK_RABID, F_RABID }, /* replaces F_ICY */
        { BL_MASK_PHASE, F_PHASE }, /* replaces F_BUSY */
        ...
        { BL_MASK_WITHER, F_WITHER }, /* replaces F_SUBMERGED */
...
static struct X_status_value shown_stats[NUM_STATS] = {
    ...
    { "Rabid",       SV_NAME,  (Widget) 0, 0L, 0, FALSE, TRUE, FALSE, 0, 0, 0 },
...
static const struct f_overload cond_ovl[] = {
    ...
    { (BL_MASK_PARLYZ | BL_MASK_SLEEPING | BL_MASK_UNCONSC),
      { { BL_MASK_PARLYZ, F_PARALYZED },
        { BL_MASK_SLEEPING, F_SLEEPING },
        { BL_MASK_UNCONSC, F_UNCONSCIOUS } },
    },
...
update_fancy_status_field(int i, const char *valstr, int color, int attributes)
{
    ...
    switch (i) {
        ...
        case F_GLOWHANDS:
            ...
            break;
        case F_PHASE: /* replaces F_ICY */
            condmask = BL_MASK_PHASE;
            break;
        case F_RABID: /* replaces F_BUSY */
        ...
        case F_SLIPPERY:
            ...
            break;
        case F_WITHER: /* replaces F_SUBMERGED */
...
static int status_indices[][13] = {
    ...
    { F_DUMMY, F_GRABBED, F_STONE, F_SLIME, F_STRNGL,
      F_FOODPOIS, F_TERMILL, F_IN_LAVA, F_RABID, F_WITHER,
      -1, 0, 0 },
    { F_DUMMY, F_HELD, F_BLIND, F_DEAF, F_STUN,
      F_CONF, F_HALLU, F_GLOWHANDS, F_PHASE, F_VERS,
      -1, 0, 0 },
};
